...
Future<List<Product>> getAllProducts() async {
  ...
  if (response.statusCode == 200) {
    ...
    fetchedProductList.shuffle(); // Randomize products list
...
Future<List<TaxTerm>> getTaxonomyTerms() async {
  ...
  if (response.statusCode == 200) {
    ...
    fetchedTermsList.shuffle(); // Randomize taxonomy terms
...
Future<void> registerViewsForProduct(int postId) async {
  await http.get('$BASE_URL/food-api/register-views/$postId');
}
